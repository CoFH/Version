...
This module contains "Integration" - all of the compatibility materials, recipes, and enhancements to make the Thermal Series play even better alongside some common - and not so common - mods. The goal is to blend both style and functionality without compromising or unbalancing the larger modded ecosystem, so config options are in place to quickly disable entire feature sets.
